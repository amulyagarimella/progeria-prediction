...
progeria_dirs_untreated = newArray("Y:/users/Ajay/Progeria drug treatment IF/Progerin_LMN_k9me3_k9me3/Untreated/2022-09-01/","Y:/users/Ajay/Sep 2022 backup/Back up Aug_2022/Progeria_Drug time course/Day0/2022-07-29/")

dir2_p = "Y:/users/Amulya/converted_v2/progeria/"
dir2_n = "Y:/users/Amulya/converted_v2/normal/"


for (p=0; p < progeria_dirs_untreated.length; p++) {
	splitchannel_mip(progeria_dirs_untreated[p], dir2_p);
}
